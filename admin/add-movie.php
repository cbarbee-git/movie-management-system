        ...
        <div class="col-sm-12">
            ...
            <div id="add-movie-form-container">
                <form class="form-horizontal" method="post" id="add-movie-form" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                            <?php
                                if(isset($movie['img_path'])){
                                    echo("<img src='../".$movie['img_path']."' alt='' width='194' height='259' style='margin-bottom:10px;' />");
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="year">Hero Image: <br /><small>(home carousel)</label>
                        <div class="col-sm-10">
                            <?php
                            if(isset($movie['hero_path'])){
                                echo("<img src='../".$movie['hero_path']."' alt='' style='margin-bottom:10px;width:40%;height:40%;' />");
                                //now use a different input group
                                ?>
